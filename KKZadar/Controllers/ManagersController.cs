...
namespace KKZadar.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ManagerID,FirstName,LastName,Country")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ManagerID,FirstName,LastName,Country")] Manager manager)
        {
